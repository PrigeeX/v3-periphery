...
contract QuoterV2 is IQuoterV2, IPrigeeXV3SwapCallback, PeripheryImmutableState {
    ...
    function getPool(
        ...
        address tokenB,
        uint24 fee
    ) private view returns (IPrigeeXV3Pool) {
        return IPrigeeXV3Pool(PoolAddress.computeAddress(factory, PoolAddress.getPoolKey(tokenA, tokenB, fee)));
    }

    /// @inheritdoc IPrigeeXV3SwapCallback
    function uniswapV3SwapCallback(
        ...
        IPrigeeXV3Pool pool = getPool(tokenIn, tokenOut, fee);
        ...
        )
    {
        ...
        IPrigeeXV3Pool pool = getPool(params.tokenIn, params.tokenOut, params.fee);
